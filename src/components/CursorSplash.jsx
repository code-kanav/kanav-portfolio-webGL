  ...
  React.useEffect(() => {
    ...
    class Material {
      ...
      setKeywords(keywords) {
        ...
        if (program == null) {
          let fs = compileShader(gl.FRAGMENT_SHADER, this.fsSrc, keywords);
          program = createProgram(this.vs, fs);
    ...
    function updateKeywords() {
      const kws = [];
      if (config.SHADING) kws.push('SHADING');
      displayMaterial.setKeywords(kws);
    }
...
// Default props match the React Bits example for a calm, premium feel.
