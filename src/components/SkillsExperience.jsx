...
export const ExperienceStack = () => {
  const roles = [
    { yr:'06/2025 — now', role:'AI Researcher / Software Engineer', co:'Stanford University', loc:'Palo Alto, CA', logo:'S',
      ...
      bullets:[
        'Launched full-stack SAGE (sage.arise-ai.org) — cut consulting time 70–80% (15min → 2–3min).',
        'Engineered prompt versioning, feedback capture, session tracking in React/TS/Node/Python; +40% experiment velocity.',
        'Designed backend logging 10K+ interactions; feedback-driven iteration improved response quality scores 25%.',
        'Architected Stanford Health Path — LLM-powered patient navigation tool, +55% patient engagement.',
        'Shipped ARISE AI research network (arise-ai.org) with Next.js + headless WordPress CMS.',
      ],
      stack:['React','TypeScript','Python','FastAPI','Claude','Gemini','Vector DB','Next.js'] },
    { yr:'03/2023 — 08/2024', role:'Senior Software Engineer', co:'Vensure Employer Solutions', loc:'Noida, UP', logo:'V',
      accent:'#1e40af', accent2:'#3b82f6',
      bullets:[
        'Led legacy → microservices migration; 40% technical debt reduction.',
        'Selected + implemented modern tech stack; 50% system efficiency gain.',
        'Architected HR Management features in Next.js, Node.js, TypeScript.',
        'Optimized UI performance 60% via minification + lazy loading.',
        'Refactored legacy codebases + mentored junior devs; significantly reduced crashes.',
      ],
      stack:['React','TypeScript','Microservices','Node.js','Next.js'] },
    { yr:'08/2019 — 03/2023', role:'Software Developer', co:'Khojdeal', loc:'Gurugram, HR', logo:'K',
      accent:'#7c2d12', accent2:'#f97316',
      bullets:[
        'Shipped CMS-based sites with 100% Core Web Vitals scores.',
        '+25% conversion via GTM + GA integration with marketing team.',
        'GitLab CI/CD + Cloudflare rollout across org and client sites.',
        'Built full e-learning simulations in pure JavaScript + TypeScript.',
        'Converted Flash apps → HTML5/JS; cross-browser + mobile compatible.',
      ],
      stack:['JavaScript','TypeScript','Python','Next.js','GTM','GA','GitLab','Cloudflare'] },
  ];
